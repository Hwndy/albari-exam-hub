...
import { FileText, CreditCard, GraduationCap, ArrowRight } from 'lucide-react';
...
const STEPS = [
  {
    ...
    body: 'Complete the online application with your child\u2019s details and upload required documents.',
  },
  {
    n: '02',
    Icon: CreditCard,
    title: 'Sit Entrance Assessment',
    body: 'Pay the application fee and attend the scheduled entrance examination and interview.',
  },
  {
    n: '03',
    Icon: GraduationCap,
    title: 'Accept Your Offer',
    body: 'Receive your offer letter, pay acceptance fees and join the Al-Bari family.',
  },
];
