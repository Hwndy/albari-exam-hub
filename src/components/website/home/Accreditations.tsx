...
import { ShieldCheck, Award, BookMarked, Building2, GraduationCap } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
          {BODIES.map(({ name, desc, Icon }) => (
            <div
              key={name}
              className="group flex flex-col items-center text-center gap-2 p-4 rounded-xl border border-transparent hover:border-gold/30 hover:bg-gold/5 transition-all"
            >
