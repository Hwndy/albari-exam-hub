...
export const AdmissionForm = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Verify class exists before submission
      let classData = null;
      if (formData.applying_for_class) {
        ...
        if (classError) {
          ...
          throw new Error('Failed to verify class information');
        }
        
        if (!data) {
          toast({
            title: 'Invalid Class Selection',
            description: 'The selected class is not available. Please refresh and try again.',
            variant: 'destructive',
          });
      ...
      // Generate a client-side UUID for the submission
      // The application_number will be auto-generated by database trigger
      const applicationId = crypto.randomUUID();

      // Insert admission application with status payment_pending
      // Application number will be auto-generated by database trigger
      ...
      const applicationNumber = applicationData?.application_number || applicationId;
