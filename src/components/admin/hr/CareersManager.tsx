...
export const CareersManager: React.FC = () => {
  ...
  const [form, setForm] = useState({
    ...
    description: '', requirements: '', apply_email: 'careers@albari.com.ng', closes_on: '',
  });
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    if (error) toast({ title: 'Failed', description: error.message, variant: 'destructive' });
      ...
      setForm({ title: '', department: '', employment_type: 'full_time', location: '', description: '', requirements: '', apply_email: 'careers@albari.com.ng', closes_on: '' });
      load();
    }
  };
